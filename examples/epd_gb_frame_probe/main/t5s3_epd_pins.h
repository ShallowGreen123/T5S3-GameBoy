...
static constexpr uint16_t kActiveX = 432;
static constexpr uint16_t kActiveY = 30;
static constexpr uint16_t kActiveWidth = 432;
static constexpr uint16_t kActiveHeight = 480;
